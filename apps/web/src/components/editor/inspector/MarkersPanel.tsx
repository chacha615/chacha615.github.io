...
export const MarkersPanel: React.FC = () => {
  ...
  <div className="space-y-1">
    {markers.sort((a, b) => a.time - b.time).map((marker) => (
      <div
        key={marker.id}
      ...
      >
        <div
          ...
          style={{ backgroundColor: editingId === marker.id ? editColor : marker.color }}
        />
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex gap-1">
              ...
              <Button
                ...
                size="small"
                className="flex-1 h-7 text-xs gap-1 bg-background-secondary hover:bg-background-primary text-text-secondary"
              >
                <X size={12} />
                Cancel
              </Button>
